...
module ``about option types`` =
    ...
    let OrTheyMightNot() =
        ...
        (* Hm, this is an odd situation. Unlike Haskell in which there _is no null_, it seems that F# does allow it... which just puts you in a weird situation, if you ask me. *)
